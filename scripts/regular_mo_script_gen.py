...
defaults = [
    {'corrected': '', 'ep': 90, 'momentum': 0.1, 'lr': 0.01, 'sign_lr': 0.1, 'c_sq': 0.8396893026590251, 'wd': None, 'sign_wd': 0.00282842712474619, 'nesterov': None, 'cos_power': None, 'power': None},
    {'corrected': None, 'ep': 90, 'momentum': 0.1, 'lr': 0.01, 'sign_lr': 0.1, 'c_sq': None, 'wd': wd, 'sign_wd': 0.00282842712474619, 'nesterov': None, 'cos_power': None, 'power': None},
]

file_prefixes = ['corrected_regular_mo_', 'regular_mo_']
...
pathlib.Path('regular_mo_done').touch()
print('Done!')
