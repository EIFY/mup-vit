...
# Files opened:
# ['unnormed_corrected_lr.sh', 'unnormed_corrected_wd.sh', 'unnormed_corrected_sign_lr.sh', 'unnormed_corrected_sign_wd.sh', 'unnormed_corrected_c_sq_lr.sh', 'unnormed_wd.sh', 'unnormed_done']
